...
fn oklab_to_xyz(lab: Oklab) -> XYZ {
    ...
    // XYZ {
    //     x: 0.99999999845051981432 * l3 + 1.3963377875 * m3 + 0.19651218624 * s3,
    //     y: 1.000000008299759 * l3 - 0.1055613421 * m3 + 1.50781159414 * s3,
    //     z: 1.000000026081325386 * l3 + 0.0361456387 * m3 + 1.79989528465 * s3,
    // }
}
