...
<small>tips: Missing path in LIBRARY_PATH environment variable
...
```
This will add the directory to the environment variable each time you start up a new Terminal window.</small>
