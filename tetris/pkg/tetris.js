...
const TetrisGameFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_tetrisgame_free(ptr >>> 0, 1));
...
export class TetrisGame {
    ...
    static __wrap(ptr) {
        ...
        obj.__wbg_ptr = ptr;
        TetrisGameFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        TetrisGameFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_tetrisgame_free(ptr, 0);
    }
    /**
     * @returns {TetrisGame}
     */
    static new() {
        const ret = wasm.tetrisgame_new();
     ...
     */
    tick(dt) {
        wasm.tetrisgame_tick(this.__wbg_ptr, dt);
    }
    /**
     * @param {number} t
     * @param {Event} e
     */
    key_event(t, e) {
        wasm.tetrisgame_key_event(this.__wbg_ptr, t, e);
    }
    /**
     * @param {number} w
     * @param {number} h
    ...
    upload_imgdata(w, h, d) {
        wasm.tetrisgame_upload_imgdata(this.__wbg_ptr, w, h, d);
    }
    /**
     * @param {string} url
    ...
    on_asset_loaded(url, data) {
        ...
        wasm.tetrisgame_on_asset_loaded(this.__wbg_ptr, ptr0, len0, ptr1, len1);
    }
    /**
     * @returns {number}
     */
    get_ratiox() {
        const ret = wasm.tetrisgame_get_ratiox(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    get_ratioy() {
        const ret = wasm.tetrisgame_get_ratioy(this.__wbg_ptr);
        return ret;
    }
}
