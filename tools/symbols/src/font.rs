...
use crate::config::LayeredTextureConfig;
use crate::edt::is_graphic_char;
...
fn generate_mip_levels(source: &RgbaImage, mip_cfg: &crate::config::SymbolMipConfig) -> MipBitmaps {
...
pub fn generate_sprite_mips(
    source: &RgbaImage,
    mip_cfg: &crate::config::SymbolMipConfig,
) -> MipBitmaps {
    let mut levels: [RgbaImage; 3] = [
        ImageBuffer::new(1, 1),
        ImageBuffer::new(1, 1),
...
// Public API: multi-resolution bitmap rendering (no SDF)
// ============================================================================
