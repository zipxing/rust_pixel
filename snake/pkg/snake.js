...
export class SnakeGame {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(SnakeGame.prototype);
        obj.__wbg_ptr = ptr;
        SnakeGameFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
     ...
     */
    static new() {
        const ret = wasm.snakegame_new();
        return SnakeGame.__wrap(ret);
    }
    /**
     * @param {number} dt
     */
    tick(dt) {
        wasm.snakegame_tick(this.__wbg_ptr, dt);
    }
    /**
     * @param {number} t
     * @param {Event} e
     */
    key_event(t, e) {
        wasm.snakegame_key_event(this.__wbg_ptr, t, e);
    }
    /**
     * @param {number} w
     * @param {number} h
    ...
    upload_imgdata(w, h, d) {
        wasm.snakegame_upload_imgdata(this.__wbg_ptr, w, h, d);
    }
    /**
     * @param {string} url
    ...
    on_asset_loaded(url, data) {
        ...
        wasm.snakegame_on_asset_loaded(this.__wbg_ptr, ptr0, len0, ptr1, len1);
    }
    /**
     * @returns {number}
     */
    get_ratiox() {
        const ret = wasm.snakegame_get_ratiox(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    get_ratioy() {
        const ret = wasm.snakegame_get_ratioy(this.__wbg_ptr);
        return ret;
    }
}
