...
pub struct PetviewGame {
    g: Game<PetviewModel, PetviewRender>,
}

pub fn init_game() -> PetviewGame {
    let m = PetviewModel::new();
    let r = PetviewRender::new();
    let mut g = Game::new(m, r, "games/petview");
    g.init();
    PetviewGame { g }
}
