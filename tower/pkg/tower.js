...
const TowerGameFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_towergame_free(ptr >>> 0, 1));

export class TowerGame {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(TowerGame.prototype);
        obj.__wbg_ptr = ptr;
        TowerGameFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        TowerGameFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_towergame_free(ptr, 0);
    }
    /**
     * @returns {TowerGame}
     */
    static new() {
        const ret = wasm.towergame_new();
        return TowerGame.__wrap(ret);
    }
    /**
     * @param {number} dt
     */
    tick(dt) {
        wasm.towergame_tick(this.__wbg_ptr, dt);
    }
    /**
     * @param {number} t
     * @param {Event} e
     */
    key_event(t, e) {
        wasm.towergame_key_event(this.__wbg_ptr, t, e);
    }
    /**
     * @param {number} w
     * @param {number} h
    ...
    upload_imgdata(w, h, d) {
        wasm.towergame_upload_imgdata(this.__wbg_ptr, w, h, d);
    }
    /**
     * @param {string} url
    ...
    on_asset_loaded(url, data) {
        ...
        wasm.towergame_on_asset_loaded(this.__wbg_ptr, ptr0, len0, ptr1, len1);
    }
    /**
     * @returns {number}
     */
    get_ratiox() {
        const ret = wasm.towergame_get_ratiox(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    get_ratioy() {
        const ret = wasm.towergame_get_ratioy(this.__wbg_ptr);
        return ret;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('tower_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
